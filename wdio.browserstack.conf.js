...
export const config = {
  ...
  baseUrl: `https://grants-platform-e2e-tests.${process.env.ENVIRONMENT}.cdp-int.defra.cloud`,
  ...
  commonCapabilities: {
    'bstack:options': {
      buildName: `grants-platform-e2e-tests-${process.env.ENVIRONMENT}` // configure as required
    }
  },
    ...
    [
      'browserstack',
      {
        ...
        testObservabilityOptions: {
          ...
          buildName: `grants-platform-e2e-tests-${process.env.ENVIRONMENT}`
        },
